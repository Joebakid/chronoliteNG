...
import jewelries from "../jewelries.json"; // Importing JSON data
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Explore our exclusive collection of jewelries at Chronolite NG."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://chronolite.com.ng/jewelries"
        />
        <meta name="twitter:card" content="summary_large_image" />
      </Helmet>
      <WatchGrid Btn={Btn} items={jewelries} />
    </>
  );
}
